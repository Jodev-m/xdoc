...
export default function SearchPage() {
  ...
  return (
    <div className="flex flex-1 flex-col p-6 max-w-4xl mx-auto w-full">
      <div className="flex items-center gap-2 mb-6 text-sm text-neutral-500 dark:text-neutral-400">
      ...
      <input
        ...
        className="w-full p-4 text-lg border dark:border-neutral-700 rounded-lg mb-6 outline-none focus:ring-2 focus:ring-neutral-300 focus:dark:ring-neutral-600"
        autoFocus
      />
